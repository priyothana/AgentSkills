...
In an interactive terminal this shows a multi-select so you can choose which of the 33 skills to install. Pipe/non-interactive invocations install all discovered skills.
